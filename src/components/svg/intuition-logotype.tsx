  ...
  return (
    <svg viewBox="0 0 311 76" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-6 md:h-10">
      ...
      <g filter="url(#filter0_b_6251_3648)">
        <path d="M94 26.6168H97.9013V52.3832H94V26.6168Z" fill="url(#paint0_linear_6251_3648)" />
        <path
        ...
        />
        <path d="M198.307 26.6168H202.209V52.3832H198.307V26.6168Z" fill="url(#paint4_linear_6251_3648)" />
        <path
          d="M211.241 29.8949V26.6168H230.731V29.8949H222.91V52.3832H219.009V29.8949H211.241Z"
          fill="url(#paint5_linear_6251_3648)"
        />
        <path d="M239.781 26.6168H243.682V52.3832H239.781V26.6168Z" fill="url(#paint6_linear_6251_3648)" />
        <path
      ...
      <defs>
        ...
        >
          ...
          <feComposite in2="SourceAlpha" operator="in" result="effect1_backgroundBlur_6251_3648" />
          <feBlend mode="normal" in="SourceGraphic" in2="effect1_backgroundBlur_6251_3648" result="shape" />
        </filter>
        <linearGradient
        ...
        >
          ...
          <stop offset="0.2" stop-color="white" stop-opacity="0.44" />
          <stop offset="0.4" stop-color="white" />
          <stop offset="0.5625" stop-color="white" stop-opacity="0.54" />
          <stop offset="0.729167" stop-color="white" />
          <stop offset="0.78125" stop-color="white" stop-opacity="0.65" />
        </linearGradient>
        <linearGradient
